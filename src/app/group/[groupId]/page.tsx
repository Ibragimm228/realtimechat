        ...
        <div className="p-3 border-t border-border bg-card/80 backdrop-blur-md min-h-[64px] flex items-center">
          <div className="w-full flex flex-col">
            ...
            <div className="max-w-3xl mx-auto w-full flex items-end gap-2.5">
              <div className="flex-1 flex items-end gap-2 bg-card rounded-[22px] px-3.5 py-1.5 shadow-sm border border-border transition-all focus-within:ring-2 focus-within:ring-green-500/20">
